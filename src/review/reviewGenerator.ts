      ...
      return client.createChatCompletion([
        ...
        },
        {
          ...
          content: [
            ...
            "输出应包含：主题分类、已有研究贡献、代表性线索、反复出现的观点、可能的研究空白、建议优先核对或精读的论文。",
            "已有研究贡献只能根据题录和摘要归纳，使用“从摘要看”“已有研究可能主要贡献在于”等限定表达，不要推断全文中的具体方法、数据或结论强度。",
    ...
    async generateDeepReview(papers) {
      return client.createChatCompletion([
        ...
        },
        {
          role: "user",
          content: [
            "请基于以下 PDF 全文生成深度综述素材；如果材料中包含题录、摘要或关键词，可以作为辅助信息参考，但不要要求这些字段必须存在。",
            "如果材料为英文或中英混合，请先理解原文含义，再用中文输出综述；专业术语、理论名称、模型名称和变量名称应保留英文原文，并在首次出现时给出中文解释。",
            "输出应包含：单篇结构化分析、已有研究贡献、方法与数据对比、研究脉络、代表论文、共同不足、研究空白、可写入综述的素材段落。",
            "已有研究贡献应优先基于 PDF 全文中的证据归纳；如摘要或关键词存在，可作为辅助线索。请说明相关论文在研究对象、理论视角、方法路径、数据材料或实践启示上的贡献，并引用对应论文ID。",
            "所有判断必须尽量引用论文ID。",
            "",
            "【论文材料开始】",
